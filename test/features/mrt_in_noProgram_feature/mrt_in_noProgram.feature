...
Scenario: There is no advertisment ready to play in playList when MRT arrive the station

    Given The player has opened and has no advertisment in playList
